<?php
    ...
    isFalse($check_name, "이름은 한글로(3~5)만 작성할 수 있습니다.<br> 올바른 이름을 작성해주세요");

    // 비밀번호 유효성 검사
    $finalPass = $youPass !== $youPassC;
    ...
    // 회원가입 결과
    $sql = "INSERT INTO boardMember(youEmail, youName, youPass, regTime) VALUES('$youEmail', '$youName', '$youPass', '$regTime')";
    $result = $connect -> query($sql);

    if (!$result) {
        msg("회원가입 과정에서 에러가 발생했습니다, 관리자에게 문의해주세요.");
    } else {
        Header("Location: /join/save");
    };
?>